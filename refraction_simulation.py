...
# Load custom font
font_path = "font.otf"  # Replace with the actual path to your font file, e.g., "./path/to/font.otf"
font_manager.fontManager.addfont(font_path)
font_prop = font_manager.FontProperties(fname=font_path)
plt.rcParams['axes.unicode_minus'] = False  # Prevent issues with negative signs
...
if theta2 is not None:
    ...
    # Total internal reflection: reflected ray back to top-left (y>0)
    x_end = -1.0
...
# Add labels and legend with fontproperties
